  ...
  return (
    <div>
      ...
      <div className="shadow-sm sm:w-full bg-background hover:shadow-lg transition p-5 mt-5 bg-slate-100 rounded">
        <h5 className={`lg:text-3xl sm:text-xl ${antonFont.className} dark:text-white`}>Top  rated movies</h5>
        <CardFilm 
      ...
      <div className="shadow-sm bg-background hover:shadow-lg transition p-5 mt-5 bg-slate-100 rounded">
        <h5 className={`text-3xl sm:text-xl ${antonFont.className}`}>Popular movies</h5>
          <CardFilm
      ...
      <div className="shadow-sm bg-background hover:shadow-lg transition p-5 mt-5 bg-slate-100 rounded">
        <h5 className={`text-3xl sm:text-xl ${antonFont.className}`}>Upcoming movies</h5>
          <CardFilm
      ...
      <div className="shadow-sm bg-background hover:shadow-lg transition p-5 mt-5 bg-slate-100 rounded">
        <h5 className={`text-3xl sm:text-xl ${antonFont.className}`}>Popular Tv series</h5>
          <CardSerie 
      ...
      <div className="shadow-sm bg-background hover:shadow-lg transition p-5 mt-5 bg-slate-100 rounded">
        <h5 className={`text-3xl sm:text-xl ${antonFont.className}`}>Top rated Tv series</h5>
          <CardSerie
      ...
      <div className="shadow-sm bg-background hover:shadow-lg transition p-5 mt-5 bg-slate-100 rounded">
        <h5 className={`text-3xl sm:text-xl ${antonFont.className}`}>On air Tv series</h5>
          <CardSerie 
